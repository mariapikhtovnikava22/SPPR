...
namespace WEB_153505_PIKHTOVNIKAVA.API.Services.ProductService
{
    public interface IProductService
    {
        ...
        /// <returns></returns>
        public Task<ResponseData<ListModel<Sneaker>>> GetProductListAsync(string?
       categoryNormalizedName, int pageNo = 1, int pageSize = 3);
        ...
        /// <returns></returns>
        public Task UpdateProductAsync(int id, Sneaker product);
        ...
        public Task<ResponseData<Sneaker>> CreateProductAsync(Sneaker product);
